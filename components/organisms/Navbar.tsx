...
export function Navbar() {
    return (
        <header className="sticky top-0 z-50 w-full px-4 py-4 md:px-10 lg:px-40 backdrop-blur-md bg-background-light/80 dark:bg-background-dark/80 border-b border-surface-border">
